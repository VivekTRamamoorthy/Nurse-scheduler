...
var instructionview=function(){
    ...
    This is an open source manual nurse scheduling interface. It is NOT an automated scheduling tool. It was originally created for my mother who is a head nurse at a local hospital responsible for creating weekly schedules for around 400 staff. <br><br> 
    ...
    This web tool was created to help her. <br><br>
    ...
    <li> You can save progress on your web browser local storage by selecting SAVE > SAVE LOCAL</li>
    ...
    <h2> Important</h2> 
    <li> DO NOT CLOSE the page without saving your progress or all progress will be discarded. </li>
    <li> SAVE your progress frequently as a CSV file and reload them later. </li>

    <h2> Data security: </h2> 
    <li> This static site does not process any data in the server end. </li>

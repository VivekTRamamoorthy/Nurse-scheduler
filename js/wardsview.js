...
var wardsview=function(){
    ...
    column1.innerHTML="<h2> HOSPITAL VIEW </h2> <p>Drag the nurses into wards. On mobile, click nurse and click on ward.<br> Or Select the automatic allocation buttons below:</p> ";
